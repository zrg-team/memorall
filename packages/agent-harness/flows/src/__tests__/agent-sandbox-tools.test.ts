...
import { extractToolResult } from "../interfaces/engine/tool.js";
import type { IAgentSandboxService } from "../interfaces/services/agent-sandbox.js";
import { createSandboxInspectTool } from "../tools/agent-sandbox/sandbox-inspect.js";
import { createSandboxNetworkTool } from "../tools/agent-sandbox/sandbox-network.js";
import { createSandboxPackagesTool } from "../tools/agent-sandbox/sandbox-packages.js";
import { createSandboxProcessTool } from "../tools/agent-sandbox/sandbox-process.js";
import { createSandboxRunTool } from "../tools/agent-sandbox/sandbox-run.js";
import { createSandboxPreviewTool } from "../tools/agent-sandbox/sandbox-preview.js";
import { createSandboxSnapshotTool } from "../tools/agent-sandbox/sandbox-snapshot.js";
import { adaptMCPTool } from "../steps/features/mcp-feature/mcp-tool-adapter.js";
import {
