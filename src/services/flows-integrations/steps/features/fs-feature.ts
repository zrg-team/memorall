...
You have access to two persistent Memorall filesystem namespaces through filesystem-style tools.

## NAMESPACES

| Namespace | Root path | Backing path | Purpose |
|---|---|---|---|
| Documents | \`/documents\` | document storage root | User documents, notes, PDFs, and other files |
| Workspaces | \`/workspaces\` | \`/home/workspace\` | Code projects, scripts, and workspace files |
		...
		outputs: [
			{
				name: "messages",
				type: "Message[]",
				description: "Messages with Memorall filesystem namespace instructions",
			},
			{
				name: "tools",
				type: "Tool[]",
