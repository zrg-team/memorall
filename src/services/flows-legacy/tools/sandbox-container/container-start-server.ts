...
import type { SandboxServerKind } from "@/services/flows-legacy/interfaces/services/sandbox";
...
export const createContainerStartServerTool: ToolFactory<Input, Services> = (
	...
	description:
		...
		"Use the returned port with container_render_server or container_request_server to access the server afterwards.",
	schema,
	execute: async (input) => {
