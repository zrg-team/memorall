import { z } from "zod";
import type { ChatCompletionToolMessageParam } from "@/services/flows-legacy/interfaces/engine/messages";
import type { FlowRuntimeVars } from "@/services/flows-legacy/runtime/runtime-context";

// Activate ServiceRegistry (side-effect — enables global augmentation)
import "@/services/flows-legacy/interfaces/services/services";
