...
export const migrations: Migration[] = [
  {
    id: 'initial',
    version: 1,
    description: 'Initial schema with knowledge graph, conversations, and trigram search',
    up: initialMigration,
  },
...
export const migrationsById = migrations.reduce((acc, migration) => {
...
export async function markMigrationApplied(db: PGlite, migration: Migration): Promise<void> {
  await db.query(`
