import type { IFlowLogger } from "@/services/flows-core/interfaces/services/logger";

export type { IFlowLogger } from "@/services/flows-core/interfaces/services/logger";
