import { z } from "zod";
import type { ChatCompletionToolMessageParam } from "@/services/flows-core/interfaces/engine/messages";
import type { FlowRuntimeVars } from "@/services/flows-core/runtime/runtime-context";

// Activate ServiceRegistry (side-effect — enables global augmentation)
import "@/services/flows-core/interfaces/services/services";
