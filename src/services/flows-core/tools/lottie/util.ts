...
/** The animation JSON file inside a project directory. */
export const animationFile = (projectPath: string, rootPath = ""): string =>
	`${normalizeProjectPath(projectPath, rootPath)}/animation.json`;
