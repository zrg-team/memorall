...
import { extractToolResult } from "@/services/flows-core/interfaces/engine/tool";
import type { IAgentSandboxService } from "@/services/flows-core/interfaces/services/agent-sandbox";
import { createSandboxInspectTool } from "@/services/flows-core/tools/agent-sandbox/sandbox-inspect";
import { createSandboxNetworkTool } from "@/services/flows-core/tools/agent-sandbox/sandbox-network";
import { createSandboxPackagesTool } from "@/services/flows-core/tools/agent-sandbox/sandbox-packages";
import { createSandboxProcessTool } from "@/services/flows-core/tools/agent-sandbox/sandbox-process";
import { createSandboxRunTool } from "@/services/flows-core/tools/agent-sandbox/sandbox-run";
import { createSandboxPreviewTool } from "@/services/flows-core/tools/agent-sandbox/sandbox-preview";
import { createSandboxSnapshotTool } from "@/services/flows-core/tools/agent-sandbox/sandbox-snapshot";
...
} from "@/services/flows-core/tools/agent-sandbox/profiles";
import {
