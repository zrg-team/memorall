...
import { extractToolResult } from "flow-core/interfaces/engine/tool";
import type { IAgentSandboxService } from "flow-core/interfaces/services/agent-sandbox";
import { createSandboxInspectTool } from "flow-core/tools/agent-sandbox/sandbox-inspect";
import { createSandboxNetworkTool } from "flow-core/tools/agent-sandbox/sandbox-network";
import { createSandboxPackagesTool } from "flow-core/tools/agent-sandbox/sandbox-packages";
import { createSandboxProcessTool } from "flow-core/tools/agent-sandbox/sandbox-process";
import { createSandboxRunTool } from "flow-core/tools/agent-sandbox/sandbox-run";
import { createSandboxPreviewTool } from "flow-core/tools/agent-sandbox/sandbox-preview";
import { createSandboxSnapshotTool } from "flow-core/tools/agent-sandbox/sandbox-snapshot";
import { adaptMCPTool } from "flow-core/steps/features/mcp-feature/mcp-tool-adapter";
import {
	getSandboxToolsForProfile,
	SANDBOX_EXECUTION_TOOLS,
	SANDBOX_WEB_APP_TOOLS,
} from "flow-core/tools/agent-sandbox/profiles";
import {
	BROWSER_SANDBOX_FEATURE_SYSTEM_PROMPT,
	BROWSER_SANDBOX_FEATURE_TOOLS,
} from "flow-core/steps/features/nodejs-sandbox-feature";
